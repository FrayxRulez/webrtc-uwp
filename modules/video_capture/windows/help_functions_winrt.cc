...
VideoType ToVideoType(_In_ const HString& sub_type) {
  ...
  struct {
    ...
    const VideoType type;
      ...
      {L"I420", VideoType::kI420},     {L"NV12", VideoType::kNV12},
      ...
      {L"{30323449-0000-0010-8000-00AA00389B71}", VideoType::kI420},
      {L"{32595559-0000-0010-8000-00AA00389B71}", VideoType::kYUY2},
      {L"{56555949-0000-0010-8000-00AA00389B71}", VideoType::kIYUV},
      {L"{31313259-0000-0010-8000-00AA00389B71}", VideoType::kYV12}
  };
