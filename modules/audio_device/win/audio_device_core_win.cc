...
struct AudioDeviceHelper : public DeviceHelper<DEVICE_CLASS> {
 ...
 public:
  ...
  virtual int32_t InitMixer() {
    ...
    } else if (DeviceHelper<DEVICE_CLASS>::_deviceId.size()) {
      ret = DeviceHelper<DEVICE_CLASS>::SetDevice(
          DeviceHelper<DEVICE_CLASS>::_deviceId);
    } else {
      ret = DeviceHelper<DEVICE_CLASS>::SetDevice(
...
int32_t AudioDeviceWindowsCore::SetPlayoutDevice(std::string deviceId) {
  webrtc::MutexLock lock(&_internal->_critSect);
  return _internal->_pRenderDeviceHelper->SetDevice(deviceId);
}

// ----------------------------------------------------------------------------
//  SetPlayoutDevice III (III)
// ----------------------------------------------------------------------------
...
int32_t AudioDeviceWindowsCore::SetRecordingDevice(std::string deviceId) {
  webrtc::MutexLock lock(&_internal->_critSect);
  return _internal->_pCaptureDeviceHelper->SetDevice(deviceId);
}

// ----------------------------------------------------------------------------
//  SetRecordingDevice III (III)
// ----------------------------------------------------------------------------
